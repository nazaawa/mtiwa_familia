...
RouteBase get $welcomeRoute => GoRouteData.$route(
      ...
      routes: [
        GoRouteData.$route(
          path: 'signup',
          factory: $SignUpSRouteExtension._fromState,
        ),
      ],
    );
...
extension $SignUpSRouteExtension on SignUpSRoute {
  static SignUpSRoute _fromState(GoRouterState state) => const SignUpSRoute();
